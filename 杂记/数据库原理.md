...
1. 除操作$\div$  
   **前提条件**  
   若$R(A_1, A_2, \cdots,A_n)$为n度关系，关系$S(B_1, B_2, \cdots, B_n)$为m度关系，只有当$\lbraceB_1, B_2, \cdots, B_n\rbrace \subseteq \lbraceA_1, A_2, \cdots,A_n\rbrace $即B是A的真子集，$m<n$时才可进行$R\div S$运算  
   **定义**   
